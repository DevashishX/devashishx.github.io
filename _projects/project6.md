...
main_page_display_description: Key highlights of Project 6 to show in the list row next to its tile.
main_page_display_description_de: Wichtige Punkte von Projekt 6 fuer die Listenansicht neben der Projektkachel.
---
